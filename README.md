...
> Repositórios desses projetos são privados (código de cliente/empresa) — descritos aqui como experiência, não como link.
...
- **Autossuficiência de infraestrutura** — configs de deploy versionadas para setup rápido e reproduzível.
- **Fronteiras claras entre projetos paralelos** — sem mistura de contexto entre projetos.
- Modelo híbrido de tooling: **Antigravity** para scaffolding paralelo e boilerplate; **Claude Code** para decisões arquiteturais e enforcement de boundaries.
...
Membro da comunidade [Heart Developers](https://heartdevs.com/) — [redes da comunidade](https://heartdevs.com/redes).
